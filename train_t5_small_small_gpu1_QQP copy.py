...
The model will be stored in folder "models/train_t5_base_full_gpu1"
    since it uses the t5-small and SMALL QQP datasets (small_q_train.csv & small_q_test.csv)
Uses GPU
"""
# @title Output
import argparse
...
args_dict = dict(
    ...
    model_name_or_path='t5-small',  # 't5-small', 't5-base',
...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = get_dataset(tokenizer=self.tokenizer, type_path="small_q_train", args=self.hparams)
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(tokenizer=self.tokenizer, type_path="small_q_test", args=self.hparams)
