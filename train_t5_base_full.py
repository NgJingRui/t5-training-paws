...
The model will be stored in folder "models/train_t5_base_full"
    since it uses the t5-base and FULL PAWs datasets (train.csv & val.csv)
"""
# @title Output
import argparse
import glob
...
model.model.save_pretrained('models/train_t5_base_full/')
