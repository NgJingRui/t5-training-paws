...
The model will be stored in folder "models/train_t5_small_small"
...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = get_dataset(tokenizer=self.tokenizer, type_path="train_small", args=self.hparams)
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(tokenizer=self.tokenizer, type_path="val_small", args=self.hparams)
...
model.model.save_pretrained('models/train_t5_small_small/')
